...
.spec-grid{display:flex;flex-wrap:wrap;gap:14px;margin:0}
.spec-item{margin:0;flex:0 1 210px;font-family:ui-sans-serif,-apple-system,sans-serif}
.spec-item img{width:100%;height:auto;max-height:150px;object-fit:contain;
...
.spec-item.broken::before{content:"Image unavailable";display:block;padding:34px 10px;
...
<div class="specimens" id="regspecimens"></div>
...
function renderReg(iso){
 ...
 specBox.innerHTML=renderSpecimenHTML(iso,v);
}
